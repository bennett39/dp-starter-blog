...
module.exports = {
  ...
  plugins: [
        ...
        feeds: [
          {
            ...
            output: "/rss.xml",
            title: "Developer Purpose RSS Feed",
          },
        ],
      },
    },
    {
      ...
      options: {
        name: `Developer Purpose: Daily`,
        short_name: `Developer Purpose`,
        start_url: `/`,
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/dp-icon.png`, // This path is relative to the root of the site.
      },
    },
  ],
}
